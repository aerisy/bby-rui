        ...
        <div class="grid-demo">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div>
                        <hr>
                        <a class="fancybox btn btn-primary" data-thumbnail="http://fancyapps.com/fancybox/demo/2_s.jpg" href="http://fancyapps.com/fancybox/demo/2_b.jpg">FancyBox-单图片</a>
                        <a class="open_fancybox btn btn-primary" href="http://fancyapps.com/fancybox/demo/1_b.jpg">FancyBox多图片</a>
                        <%--<img src="http://fancyapps.com/fancybox/demo/1_s.jpg" alt=""/>--%>
                    </div>
                    <div>
                        <hr>
                        <ul>
                            <li><i class="typcn typcn-adjust-brightness"></i>--<i class="typcn typcn-adjust-contrast"></i>--<i class="typcn typcn-anchor-outline"></i>--<i class="typcn typcn-anchor"></i>--<i class="typcn typcn-archive"></i>--<i class="typcn typcn-arrow-back-outline"></i>--<i class="typcn typcn-arrow-back"></i>--<i class="typcn typcn-arrow-down-outline"></i>--</li>
                            <li><i class="typcn typcn-arrow-down-thick"></i>--<i class="typcn typcn-arrow-down"></i>--<i class="typcn typcn-arrow-forward-outline"></i>--<i class="typcn typcn-arrow-forward"></i>--<i class="typcn typcn-arrow-left-outline"></i>--<i class="typcn typcn-arrow-left-thick"></i>--</li>
                        </ul>
                    </div>
                </div>
            </div>
